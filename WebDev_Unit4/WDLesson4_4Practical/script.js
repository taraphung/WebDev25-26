...
function generateProblem(){
       ...
       let num1 = Math.floor(Math.random() * (20-0+1));
       let num2 = Math.floor(Math.random() * (20-0+1));
       correct = num1 + num2;
...
/* Challenge 3: Complete the function checkResponse by ,
       ...
       4) Using an if / else statement check to see if the user response is correct. 
           a) if the response is correct, set msg to "Correct!" along with the correct image
...
function checkResponse(){
       ...
       let a = parseInt(document.getElementById("response").value);
       let msg = "";
       let filename = "";
